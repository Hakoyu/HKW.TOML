...
internal static class HKWToml
{
    public static void Main(string[] args)
    {
#if DEBUG
        //var toml = TOML.Parse("TestEnum = \"Value1\"\nTestEnums = [\"Value1\",\"Value2\"]");
        //var test = TomlDeserializer.Deserialize<ConfigModel>(toml);
...
{
    public TestType TestEnum { get; set; }

    public List<TestType> TestEnums { get; set; } = new();
}
