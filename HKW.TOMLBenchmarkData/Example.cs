...
public static class Example
{
    ...
    public static string TomlExampleData =>
        """"
            ...
            # Simple key/value with a string.
            title = "HKWTOML example 😊"
            desc = "An example HKWTOML document. "
            # Array with integers and floats in the various allowed formats.
            integers = [ 42, 66, 34, 6 ]
            floats = [ 1.42, 0.01 ]
            # Array with supported datetime formats.
            times = [ 2021-11-09T15:16:17+01:00, 2021-11-09T15:16:17Z, 2021-11-09T15:16:17, 2021-11-09, 15:16:17 ]
            # Durations.
            duration = [ "4m49s", "8m03s", "1231h15m55s" ]
            # Table with inline tables.
            ...
            [characters]
            star-trek = [ { name = "James Kirk", rank = "Captain" }, { name = "Spock", rank = "Science officer" } ]
    ...
    public static string TomlExampleDataWithoutTime =>
        """"
            # This is an example HKWTOML document which shows most of its features.
    ...
    public static string JsonExampleDataWithoutTime =>
        """
            {
              "title": "HKWTOML example 😊",
              "desc": "An example HKWTOML document. ",
