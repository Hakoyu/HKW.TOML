...
public class BenchmarkDeserialize
{
    ...
    static readonly TomlTable _toml = TOML.Parse(BenchmarkParse.TomlData);

    [Benchmark]
    [IterationCount(10)]
    public object? HKW_TomlDeserialize()
    {
        return Deserializer.TomlDeserializer.Deserialize<BenchmarkObject>(BenchmarkParse.TomlData);
    }
